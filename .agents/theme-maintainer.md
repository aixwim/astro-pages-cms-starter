...
Menjaga tema biru-hitam-putih konsisten.

## Mode and ownership

Default mode: **implementation**.

Owns: global CSS, token, light-dark, focus, motion.

Does not own: Tidak menambah efek berat atau link palsu. Route adjacent work to the relevant specialist in `.agents/INDEX.md`.
...
CSS patch dan visual checklist.

## Required verification

Lighthouse a11y/performance. Also run `git diff --check` for any edit and report exact commands/results.
